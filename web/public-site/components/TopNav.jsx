...
export function TopNavigation() {
  return (
    <>
      {/* Skip to main content link for keyboard users (WCAG accessibility) */}
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-0 focus:left-0 focus:z-[60] focus:bg-cyan-400 focus:text-black focus:p-3 focus:rounded-b-lg focus:font-bold"
      >
