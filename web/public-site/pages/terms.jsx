      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            These Terms of Service ("Terms") constitute a legal agreement between you and GLAD Labs, Inc. 
            ("Company," "we," "us," or "our") governing your use of our website https://gladlabs.io 
            and related services (collectively, the "Services").
          </p>
          <p className="text-gray-700 mb-4">
            By accessing, browsing, or using the Services, you acknowledge that you have read, understood, 
            and agree to be bound by these Terms. If you do not agree to these Terms, please do not use our Services.
          </p>
          <p className="text-gray-700">
            <strong>Important:</strong> If you are accessing the Services on behalf of a company or organization, 
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>Reproduce, duplicate, copy, or sell the Services or its content</li>
            ...
            <li>Access the Services for benchmarking or competitive analysis</li>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <li>Access or use the Services on behalf of others without authorization</li>
        ...
        <section className="mb-12">
          ...
          <h3 className="text-xl font-bold mb-3">4.1 Our Intellectual Property</h3>
          <p className="text-gray-700 mb-4">
            All content, features, and functionality of the Services (including but not limited to software, 
            code, design, text, images, and graphics) are owned by GLAD Labs, our licensors, or other providers 
            of such material and are protected by copyright, trademark, and other intellectual property laws.
          </p>

          <h3 className="text-xl font-bold mb-3">4.2 Your Content</h3>
          <p className="text-gray-700 mb-4">
            You retain ownership of any content you create or upload to the Services ("Your Content"). 
          ...
          <p className="text-gray-700">
            You represent that you own or have sufficient rights to grant us this license.
          </p>
        </section>

        {/* Limitations */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-4">5. Limitations of Liability & Disclaimers</h2>
          
          <h3 className="text-xl font-bold mb-3">5.1 Disclaimer of Warranties</h3>
          <p className="text-gray-700 mb-4">
            <strong>THE SERVICES ARE PROVIDED "AS-IS" WITHOUT WARRANTIES OF ANY KIND.</strong> We disclaim all warranties, 
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">5.2 Limitation of Liability</h3>
          <p className="text-gray-700 mb-4">
            <strong>TO THE MAXIMUM EXTENT PERMITTED BY LAW:</strong>
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>We shall not be liable for indirect, incidental, special, consequential, or punitive damages</li>
            <li>Our total liability shall not exceed the amount you paid us in the 12 months prior</li>
            <li>These limitations apply even if we've been advised of potential damages</li>
          </ul>

          <h3 className="text-xl font-bold mb-3 mt-6">5.3 User Responsibility</h3>
          <p className="text-gray-700">
            You assume all risk and responsibility for your use of the Services. This includes decisions made 
            based on information provided by the Services.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700">
            You agree to indemnify, defend, and hold harmless GLAD Labs, its officers, directors, employees, 
            and agents from any claims, damages, or costs arising from:
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
            <li>Fees are exclusive of taxes (you're responsible for applicable taxes)</li>
            <li>Billing occurs on the day of your subscription and recurring thereafter</li>
        ...
        <section className="mb-12">
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">8.3 Effect of Termination</h3>
          <p className="text-gray-700">
            Upon termination, your right to use the Services ends immediately. We may retain your data 
            for compliance and legal purposes as required by applicable laws.
          </p>
        </section>
        ...
        {/* Modifications */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-4">10. Modifications to Terms & Services</h2>
          <p className="text-gray-700 mb-4">
            We reserve the right to modify these Terms at any time. Significant changes will be communicated 
            via email or prominent notice on the Services. Your continued use constitutes acceptance of modified Terms.
          </p>
          <p className="text-gray-700">
            We may also modify, suspend, or discontinue the Services (or any features) with or without notice. 
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            These Terms are governed by the laws of California, without regard to conflicts of law principles. 
            Any legal action or proceeding shall be exclusively brought in the state or federal courts located 
            in San Francisco, California, and you consent to jurisdiction there.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            Before pursuing legal action, we encourage you to contact us at legal@gladlabs.io to attempt 
          ...
          <p className="text-gray-700">
            ...
            binding arbitration under the rules of the American Arbitration Association (AAA), except for 
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700">
            If any provision of these Terms is found invalid or unenforceable, that provision shall be modified 
            to the minimum extent necessary to be enforceable, and the remaining provisions shall remain in full effect.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <p className="mb-2"><strong>Email:</strong> legal@gladlabs.io</p>
            <p className="mb-2"><strong>Mail:</strong> GLAD Labs, Inc., Legal Team</p>
